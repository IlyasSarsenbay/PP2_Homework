...
class Ball(pygame.sprite.Sprite):
    def __init__(self, x, speed, surf, score, group,size1,size2):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(surf,(size1,size2))
...
def createBall(group):
    ...
    size1 = random.randint(40, 50)
    size2 = random.randint(30, 40)
    return Ball(x, speed, balls_surf[indx], balls_data[indx]['score'], group, size1,size2)
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          ...
          pygame.quit()
          sys.exit()  
    if game_score==100 or game_score==200 or game_score==150:
                   SPEED=10
